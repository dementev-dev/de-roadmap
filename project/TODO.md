...
- [ ] **CI-проверка внешних ссылок.**
  В роадмапе ~100 внешних ссылок, репозиторий правится редко — ссылки гниют молча.
  GitHub Action (например, lychee) по расписанию раз в неделю, с игнор-листом
  доменов, режущих ботов (habr, stepik, leetcode, realpython и т.п. отвечают
  только браузерам). Аудит 2026-07-12 нашёл битые ссылки вручную — автоматика
  избавит от повторов.
